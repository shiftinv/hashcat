...
KERNEL_FQ void m42000_init (KERN_ATTR_TMPS_ESALT(pbkdf2_sha1_tmp_t, aes_target_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m42000_loop (KERN_ATTR_TMPS_ESALT(pbkdf2_sha1_tmp_t, aes_target_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void m42000_comp (KERN_ATTR_TMPS_ESALT(pbkdf2_sha1_tmp_t, aes_target_t))
{
  const u64 gid = get_global_id (0);
